...
@app.route("/")
def home():
  return "<title>Home Page</title>Welcome to this file hosting server<br/><br/>Click <a href=/upload>Here</a> to Upload a file<br>After that simply go to <code>/download/filename</code>"
